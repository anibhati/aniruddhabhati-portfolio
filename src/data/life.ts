...
export const cooking: Cooking = {
  ...
  body: [
    ...
    "Now it's what calms me down after a long day, and chicken curry is the dish I keep coming back to. It's the same thing I like about building software: start from a recipe, then figure out what makes it yours.",
  ],
  photos: [
    { src: "/life/cooking-1.jpg", alt: "A dish I cooked" },
    { src: "/life/cooking-2.jpg", alt: "Cooking in my kitchen" },
  ],
};
